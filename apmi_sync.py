...
# provider/IA name APMI expects in its dropdowns, plus a clean display `name`
# used for the pms_list.name column (which is NOT NULL in Supabase).
# ---------------------------------------------------------------------------
PMS_MAP = [
    {"id": "stallion",     "name": "Stallion Asset",               "provider": "Stallion Asset Private Limited",              "ia_name": "STALLION ASSET CORE FUND"},
    {"id": "negen",        "name": "Negen Capital",                "provider": "Negen Capital Services Private Lmited",       "ia_name": "Negen Special Situations & Dynamic Allocation Strategy"},
    {"id": "abakkus",      "name": "Abakkus",                      "provider": "Abakkus Asset Manager Private Limited",       "ia_name": "Abakkus Diversified Alpha Approach"},
    {"id": "sameeksha",    "name": "Sameeksha Capital",            "provider": "Sameeksha Capital Private Limited",           "ia_name": "Sameeksha India Equity Fund"},
    {"id": "hem_dream",    "name": "Hem Securities (DREAM)",       "provider": "Hem Securities Limited",                      "ia_name": "Dynamic Research & Emerging Asset Management Strategy (DREAM)"},
    {"id": "icici_pipe",   "name": "ICICI Prudential PMS (PIPE)",  "provider": "ICICI Prudential Asset Management Company Ltd","ia_name": "ICICI Prudential PMS PIPE Strategy"},
    {"id": "buoyant",      "name": "Buoyant Capital",              "provider": "Buoyant Capital Private Limited",             "ia_name": "Buoyant Opportunities PMS"},
    {"id": "renaissance",  "name": "Renaissance Investment Managers", "provider": "Renaissance Investment Managers Private Limited", "ia_name": "Renaissance India Next Portfolio"},
    {"id": "2point2",      "name": "2Point2 Capital",              "provider": "2point2 Capital Advisors Llp",                "ia_name": "2Point2 Long Term Value Fund"},
    {"id": "hem_sme",      "name": "Hem Securities (SME)",         "provider": "Hem Securities Limited",                      "ia_name": "India Rising SME Stars"},
]

# Quick id -> display name lookup, built from PMS_MAP above.
PMS_NAME_BY_ID = {item["id"]: item["name"] for item in PMS_MAP}
...
def push_to_supabase(results):
    ...
    for r in results:
        ...
        payload = {
            "id": r["id"],
            "name": PMS_NAME_BY_ID.get(r["id"], r["id"]),
            "updated_at": now,
        }
